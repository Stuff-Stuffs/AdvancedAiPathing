package io.github.stuff_stuffs.advanced_ai_pathing.common.internal.pathing;
...
import io.github.stuff_stuffs.advanced_ai_pathing.common.api.util.CopyOnWriteMap;
import org.jetbrains.annotations.Nullable;

public class SectionData {
    private final State current = new State();
    private final State stale = new State();
    ...
    public void purgeAll() {
        stale.sections.move(current.sections);
    }
